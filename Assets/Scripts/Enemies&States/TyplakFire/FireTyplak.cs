...
public class FireTyplak : MovingMeleeEnemy
{
    private IFireTyplakState currentState;
    [SerializeField]
    ...
    public override void Start()
    {
        ...
        SetIndexes();
        isAttacking = false;
        ChangeState(new FireTyplakPatrolState());
    }
    ...
    public void ChangeState(IFireTyplakState newState)
    {
